...
def careplan_research(age, sex, chat, careplan, scratchpad, discussion):
    task = Task(
        description=f"""
---
...
{chat}
---
You are discussing the care plan that another care plan writer (Person A) wrote for this dialogue one section at a time.
...
Once you have gone through each section and have confirmed each section with Person A, and you are satisfied with all of the corrections added to the scratchpad and /or all of 
erson A's reasoning to reject additional corrections, output the tag "[ DONE ]".
