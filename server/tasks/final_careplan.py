...
from agents.main import editor_careplan


def final_careplan(age, sex, chat, careplan, scratchpad):
    task = Task(
        description=f"""
---
...
---
""",
        expected_output="output the corrected care plan",
        agent=editor_careplan,
    )
